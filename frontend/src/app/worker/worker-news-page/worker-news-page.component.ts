...
@Component({
  selector: 'app-worker-news-page',
  templateUrl: './worker-news-page.component.html',
  styleUrls: ['./worker-news-page.component.css']
})
export class WorkerNewsPageComponent implements OnInit {
